	...
	<div class="container">
			...
			<input type="hidden" value ="<?php echo $row['id'] ?>" name="id">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="nameInput" name="name" value="<?php echo $row['name'] ?>">
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <select class="form-control" id="type" name="type" value="<?php echo $row['type'] ?>">
			      <option>small</option>
			      <option>large</option>
			    </select>
			  </div>
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="hobbiesInputInput" name="hobbies" value="<?php echo $row['hobbies'] ?>">
			  </div>
